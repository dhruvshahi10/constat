#!/usr/bin/env python3
"""
produce_demo_video.py -- cut the raw Pramana screen capture into a PRODUCED,
...
# --------------------------------------------------------------------------
# Brand palette (exact values from the Pramana design tokens)
# --------------------------------------------------------------------------
...
def render_title(i: int, n: int) -> Image.Image:
    ...
    if a2 > 0:
        f = font("mono", 11)
        draw_over(img, lambda d: draw_tracked(d, (x0, 392), "PRAMANA DESK / EVIDENCE GATED ANSWER ENGINE",
