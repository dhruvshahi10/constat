...
from trustops import brand  # noqa: E402
...
.panel{background:var(--surface-card);border:1px solid var(--line-1);border-radius:3px;
padding:3.1mm 3.8mm}
.panel h3{font-size:10.5pt;margin-bottom:1.4mm}
...
<div class="sheet">
  <div class="mast">
    <span class="wordmark"><b>Trust</b>Ops</span>
  ...
  <div>
    ...
    <p class="lede">TrustOps answers security questionnaires from your own approved evidence.
  ...
  <div class="ctafoot">
    ...
    <span class="mono">github.com/dhruvshahi10/trustops<br>dhruv.shahi07@gmail.com</span>
  </div>
</div>
"""
...
def build() -> Path:
    html = (
        ...
        "<title>TrustOps one pager</title>"
