...
Purpose and intended use. Pramana is an AI-assisted system that drafts and refuses answers to customer security questionnaires from a governed evidence corpus. It is not a decision-making system, it does not act autonomously, and its outputs are proposals subject to deterministic validation and human accountability.
