...
Palette, type and component vocabulary come from constat.brand, which is the
...
<title>Constat run report, {html.escape(res.tenant)}</title>
...
{nav}
<footer>
Constat v0 / synthetic tenant data only / hash chained audit log: {res.audit_path.name}
