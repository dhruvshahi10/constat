...
- 2026-08-08 — pramana-v0.zip shipped `make_questionnaire.py` with the web-chat sandbox's absolute output path (`/home/claude/…`), which crashes anywhere else. Output path now derives from `__file__`.
